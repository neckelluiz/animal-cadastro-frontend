        ...
        <div className="min-h-screen bg-[#f7f9fc] text-[#495057] flex justify-center">
            <div className="w-full max-w-none p-5 m-0 font-[Poppins,sans-serif]">
                <div className="text-center mb-10">
                    <h1 className="m-0 font-semibold text-[2.5em] text-[#34495e] bg-gradient-to-r from-primary">
              ...
              <span className="pointer-events-none absolute left-[18px] top-1/2 -translate-y-1/2 text-[#adb5bd] text-[1.1rem]">
                ...
                {(isCreating || selectedAnimal) && (
                    <div className="fixed inset-0 z-[1000] bg-[rgba(0,0,0,0.5)] flex justify-center items-center p-4">
                        <div
                            className="relative bg-white rounded-[16px] shadow-[0_10px_40px_rgba(0,0,0,0.2)] p-[30px] w-[90%] max-w-[500px]"
                            style={{ animation: "fadeIn 0.3s ease-out" }}>
                            <div className="relative mb-[25px] flex items-center justify-center">
                                <h2 className="text-[1.8em] font-semibold text-[#34495e]">
                                ...
                                <button
                                    className="absolute right-0 text-[1.8em] border-none bg-transparent cursor-pointer text-[#888] transition hover:text-[#333]"
                                ...
                                <>
                                    ...
                                    <div className="grid grid-cols-2 gap-5 mb-5 max-[768px]:grid-cols-1">
                                        <div className="bg-[#f8f9fa] p-[15px] rounded-[12px] text-left">
                                          <span className="block text-[0.9em] text-[#7f8c8d] mb-[5px]">
                                            Espécie
                                          </span>
                                    ...
                                    <div className="mt-[25px] flex w-full justify-center gap-[15px] max-[768px]:flex-col-reverse">
                                        <button
                                            type="button"
